...
export function EpisodeActions({ entry, canRate, rating, onRate, onWatch, onRewatch, onUnwatch, pending }: EpisodeActionsProps) {
...
export function MediaActions({ media, isSaved, status, rating, notificationsEnabled, add, update, updateNotifications, watched, onWatch, onUnwatch, pending }: MediaActionsProps) {
