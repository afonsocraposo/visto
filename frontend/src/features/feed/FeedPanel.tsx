...
export function FeedPanel() {
  ...
  return <>
    ...
    {feed.hasNextPage && <Group justify="center" mt="md">
      <Button variant="light" onClick={() => void feed.fetchNextPage()} loading={feed.isFetchingNextPage}>Load more activity</Button>
    </Group>}
