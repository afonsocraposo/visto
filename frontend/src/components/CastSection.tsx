  ...
  return (
    ...
    >
      ...
      <div className="cast-member-copy">
        <Text className="cast-member-name" fw={700} size="sm" lineClamp={2}>
          {member.name}
        </Text>
        <Text className="cast-member-character" size="xs" c="dimmed" lineClamp={2}>
          {member.character || fallbackRole}
        </Text>
      </div>
    </Paper>
  );
